...
const RoadmapGeneration = () => {
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      case "foundation": return "bg-primary/20 text-primary border-primary/30";
      case "intermediate": return "bg-[var(--primary-light)]/45 text-[var(--text-dark)] border-[var(--primary-light)]";
      case "advanced": return "bg-[#D2C4B4]/55 text-[var(--text-dark)] border-[#D2C4B4]";
      case "certification": return "bg-primary/15 text-primary border-primary/30";
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex items-center space-x-4 text-sm">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-primary">AI Consultation</span>
            </div>
        ...
        <Card className="mb-8 bg-gradient-glass border-border/50 shadow-medium">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Badge className="text-lg px-4 py-2 bg-[var(--primary)] text-white">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <Badge variant="outline" className="mt-4 text-primary border-primary/30">
                  High intensity
                </Badge>
              </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[var(--primary-light)]/40 rounded-full flex items-center justify-center">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 bg-[var(--primary-light)] rounded"></div>
                      <span>Intermediate (60%+)</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 bg-[#D2C4B4] rounded"></div>
                    ...
                    <div key={resource.id} className="flex items-center gap-3 p-3 border border-border/50 rounded-lg hover:bg-muted/20 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                          ...
                          <Badge
                            variant="outline"
                            className={`text-xs ${resource.price === 'free' ? 'text-primary border-primary/30' : 'text-[var(--text-dark)] border-[#D2C4B4]'}`}
                          >
                            {resource.price}
                          </Badge>
                        </div>
